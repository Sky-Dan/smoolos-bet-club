...
export const Wallet = () => {
      ...
      >
        <div className="flex flex-col p-4 bg-white rounded-md">
          ...
          <span className="text-gray-600">
            Please ensure your wallet is connected to the following network and
            try again.
          </span>
          <span>For more information:</span>
          <CustomLink
            href={HOW_ADD_CUSTOM_RPC_LINK}
          ...
          {switchError && (
            <button
              className="p-2 mt-2 text-white bg-black rounded-md"
  ...
  return (
    ...
    >
      <button className="p-2 border-2 border-purple-500 border-solid rounded-md bg-gradient-to-t from-purple-900 via-purple-800 to-purple-900">
